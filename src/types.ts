...
export type ProcessedItem = { id: string; sourceName: string; name: string; blob: Blob; preview: string; originalSize: number; outputSize: number; status: 'done' | 'processing' | 'error' }
