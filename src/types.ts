...
export type ProcessedItem = { id: string; sourceName: string; name: string; blob: Blob; preview: string; originalSize: number; outputSize: number; width?: number; height?: number; warning?: string; status: 'done' | 'processing' | 'error' }
